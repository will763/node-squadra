...
const BancoErro_1 = __importDefault(require("./BancoErro"));
const middlewareErro = (error, req, res, next) => {
    var _a, _b;
    if (error instanceof BancoErro_1.default) {
        if ((_a = error === null || error === void 0 ? void 0 : error.mensagem) === null || _a === void 0 ? void 0 : _a.includes("invalid username/password; logon denied")) {
            const resposta = {
        ...
        if ((_b = error === null || error === void 0 ? void 0 : error.mensagem) === null || _b === void 0 ? void 0 : _b.includes('ECONNREFUSED')) {
            const resposta = {
